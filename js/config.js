...
UZI: {
    ...
    DOUBLE_GUN: {
      ...
      cooldown: 150,
      cost: 200,
      desc: 'Dos balas paralelas, alternando arriba y abajo',
      bulletColor: 0x4dd4ff,
      bulletSize: 6,
      double: true,
      img: 'weapon_doublegun_img',
    },
    BAZOOKA: {
      label: 'BAZOOKA',
      damage: 5,
      cooldown: 2000,
      cost: 450,
      desc: 'Bala perforante + explosiones en cadena a lo largo de la línea',
      bulletColor: 0xff8b39,
      bulletSize: 60,
      pierce: true,
      bazooka: true,
      explosionDamage: 3,
      explosionRadius: 100,
      img: 'weapon_bazooka1_img',
      imgFiring: 'weapon_bazooka2_img',
      bulletImg: 'weapon_bazooka_bullet',
    },
  }),
});