const CFG = Object.freeze({
  ...
  // ---- POWER UP ----
  POWER_UP_SPAWN_INTERVAL: 90000, // 90s globales entre apariciones de power ups
  ...
  POWER_UPS: Object.freeze({
    ...
    HEALING: { label: 'HEALING', color: 0x39ff6e, icon: 'H' },
    BIG_BOOM: { label: 'BIG BOOM', color: 0xff8b39, icon: 'O', img: 'powerup_bigboom_img' },
    SHIELD: { label: 'SHIELD', color: 0x4dd4ff, icon: 'S' },
  }),
